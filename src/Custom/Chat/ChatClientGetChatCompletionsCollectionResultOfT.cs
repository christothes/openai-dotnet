...
namespace OpenAI.Chat
{
    internal partial class ChatClientGetPMChatCompletionsCollectionResultOfT : CollectionResult<ChatCompletionResult>
    {
        ...
        public ChatClientGetPMChatCompletionsCollectionResultOfT(ChatClient client, string after, int? limit, string order, IDictionary<string, string> metadata, string model, RequestOptions options)
        {
            _client = client;
            _after = after;
            _limit = limit;
