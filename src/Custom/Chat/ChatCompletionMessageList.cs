...
namespace OpenAI.Chat
{
    ...
    public partial class ChatCompletionMessageList
    {
        ...
        internal ChatCompletionMessageList(string @object, IList<ChatCompletionMessageListDatum> data, string firstId, string lastId, bool hasMore, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
