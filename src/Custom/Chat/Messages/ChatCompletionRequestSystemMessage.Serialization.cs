...
{
    public partial class ChatCompletionRequestSystemMessage : ChatMessage, IJsonModel<ChatCompletionRequestSystemMessage>
    {
        ...
        internal static ChatCompletionRequestSystemMessage DeserializeChatCompletionRequestSystemMessage(JsonElement element, ModelReaderWriterOptions options)
        {
            ...
            return new ChatCompletionRequestSystemMessage(role, content, additionalBinaryDataProperties, name);
        }
