...
namespace OpenAI.Chat
{
    ...
    public partial class CreateChatCompletionResponseChoiceLogprobs
    {
        ...
        internal CreateChatCompletionResponseChoiceLogprobs() : this(null, null, null)
        {
        }

        internal CreateChatCompletionResponseChoiceLogprobs(IReadOnlyList<ChatTokenLogProbabilityDetails> content, IReadOnlyList<ChatTokenLogProbabilityDetails> refusal, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
