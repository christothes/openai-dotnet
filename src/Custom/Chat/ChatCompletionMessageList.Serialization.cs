...
namespace OpenAI.Chat
{
    ...
    {
        internal ChatCompletionMessageList() : this(null, null, null, null, default, null)
        {
        }
        ...
        protected virtual ChatCompletionMessageList JsonModelCreateCore(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            ...
            return DeserializeChatCompletionMessageList(document.RootElement, options);
        }

        internal static ChatCompletionMessageList DeserializeChatCompletionMessageList(JsonElement element, ModelReaderWriterOptions options)
        {
        ...
        public static explicit operator ChatCompletionMessageList(ClientResult result)
        {
            ...
            return DeserializeChatCompletionMessageList(document.RootElement, ModelSerializationExtensions.WireOptions);
        }
    }
}
