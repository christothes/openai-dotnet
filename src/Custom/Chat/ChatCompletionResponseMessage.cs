...
namespace OpenAI
{
    ...
    public partial class ChatCompletionResponseMessage
    {
        ...
        internal ChatCompletionResponseMessage(string content, string refusal, IReadOnlyList<ChatToolCall> toolCalls, IReadOnlyList<ChatMessageAnnotation> annotations, ChatMessageRole role, InternalChatCompletionResponseMessageFunctionCall functionCall, ChatOutputAudio audio, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
