...
[CodeGenSuppress("CreateFineTuningJob", typeof(FineTuningOptions), typeof(CancellationToken))]
[CodeGenSuppress("GetPaginatedFineTuningJobsAsync", typeof(string), typeof(long?), typeof(CancellationToken))]
[CodeGenSuppress("GetPaginatedFineTuningJobs", typeof(string), typeof(long?), typeof(CancellationToken))]
...
[CodeGenSuppress("CancelFineTuningJobAsync", typeof(string), typeof(CancellationToken))]
[CodeGenSuppress("CancelFineTuningJob", typeof(string), typeof(CancellationToken))]
[CodeGenSuppress("GetFineTuningEventsAsync", typeof(string), typeof(string), typeof(long?), typeof(CancellationToken))]
[CodeGenSuppress("GetFineTuningEvents", typeof(string), typeof(string), typeof(long?), typeof(CancellationToken))]
[CodeGenSuppress("GetFineTuningJobCheckpointsAsync", typeof(string), typeof(string), typeof(long?), typeof(CancellationToken))]
[CodeGenSuppress("GetFineTuningJobCheckpoints", typeof(string), typeof(string), typeof(long?), typeof(CancellationToken))]
...
[CodeGenSuppress("RetrieveFineTuningJob", typeof(string), typeof(CancellationToken))]
[CodeGenSuppress("RetrieveFineTuningJobAsync", typeof(string), typeof(CancellationToken))]
[CodeGenSuppress("GetFineTuningCheckpointPermissions", typeof(string), typeof(string), typeof(long?), typeof(VectorStoreCollectionOrder?), typeof(string), typeof(CancellationToken))]
[CodeGenSuppress("GetFineTuningCheckpointPermissionsAsync", typeof(string), typeof(string), typeof(long?), typeof(VectorStoreCollectionOrder?), typeof(string), typeof(CancellationToken))]
