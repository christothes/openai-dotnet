...
namespace OpenAI.VectorStores
{
    internal partial class VectorStoreClientGetVectorStoreFilesInBatchCollectionResultOfT : CollectionResult<VectorStoreFile>
    {
        ...
        public VectorStoreClientGetVectorStoreFilesInBatchCollectionResultOfT(VectorStoreClient client, string vectorStoreId, string batchId, long? limit, string order, string after, string before, string filter, RequestOptions options)
        {
