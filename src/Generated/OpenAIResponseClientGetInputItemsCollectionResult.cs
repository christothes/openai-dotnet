...
namespace OpenAI.Responses
{
    internal partial class OpenAIResponseClientGetInputItemsCollectionResult : CollectionResult
    {
        ...
        public OpenAIResponseClientGetInputItemsCollectionResult(OpenAIResponseClient client, string responseId, long? limit, string order, string after, string before, RequestOptions options)
        {
