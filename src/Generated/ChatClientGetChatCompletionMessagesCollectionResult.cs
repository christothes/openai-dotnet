...
namespace OpenAI.Chat
{
    internal partial class ChatClientGetChatCompletionMessagesCollectionResult : CollectionResult
    {
        ...
        public ChatClientGetChatCompletionMessagesCollectionResult(ChatClient client, string completionId, string after, long? limit, string order, RequestOptions options)
        {
