...
namespace OpenAI.Assistants
{
    internal partial class InternalAssistantMessageClientGetMessagesCollectionResult : CollectionResult
    {
        ...
        internal InternalAssistantMessageClientGetMessagesCollectionResult(InternalAssistantMessageClient client, string threadId, long? limit, string order, string after, string before, RequestOptions options)
        {
