...
namespace OpenAI.Assistants
{
    public partial class RunCollectionOptions : IJsonModel<RunCollectionOptions>
    {
        ...
        protected virtual void JsonModelWriteCore(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(RunCollectionOptions)} does not support writing '{format}' format.");
            }
        ...
        RunCollectionOptions IJsonModel<RunCollectionOptions>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options) => JsonModelCreateCore(ref reader, options);
        ...
        protected virtual RunCollectionOptions JsonModelCreateCore(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(RunCollectionOptions)} does not support reading '{format}' format.");
            }
            using JsonDocument document = JsonDocument.ParseValue(ref reader);
            return DeserializeRunCollectionOptions(document.RootElement, options);
        }

        internal static RunCollectionOptions DeserializeRunCollectionOptions(JsonElement element, ModelReaderWriterOptions options)
        {
            ...
            RunCollectionOrder? order = default;
