...
namespace OpenAI.Assistants
{
    internal partial class InternalAssistantMessageClientGetMessagesAsyncCollectionResult : AsyncCollectionResult
    {
        ...
        internal InternalAssistantMessageClientGetMessagesAsyncCollectionResult(InternalAssistantMessageClient client, string threadId, long? limit, string order, string after, string before, RequestOptions options)
        {
