...
namespace OpenAI.Assistants
{
    internal partial class InternalAssistantRunClientGetRunStepsAsyncCollectionResultOfT : AsyncCollectionResult<RunStep>
    {
        ...
        internal InternalAssistantRunClientGetRunStepsAsyncCollectionResultOfT(InternalAssistantRunClient client, string threadId, string runId, long? limit, string order, string after, string before, IEnumerable<InternalIncludedRunStepProperty> include, RequestOptions options)
        {
        ...
        protected override async IAsyncEnumerable<RunStep> GetValuesFromPageAsync(ClientResult page)
        {
            foreach (RunStep item in ((InternalListRunStepsResponse)page).Data)
            {
                yield return item;
                await Task.Yield();
            }
