...
namespace OpenAI.Containers
{
    internal partial class ContainerClientGetContainerFilesAsyncCollectionResultOfT : AsyncCollectionResult<ContainerFileResource>
    {
        ...
        public ContainerClientGetContainerFilesAsyncCollectionResultOfT(ContainerClient client, string containerId, long? limit, string order, string after, RequestOptions options)
        {
