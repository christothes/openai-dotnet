...
namespace OpenAI.Containers
{
    internal partial class ContainerClientGetContainerFilesCollectionResultOfT : CollectionResult<ContainerFileResource>
    {
        ...
        public ContainerClientGetContainerFilesCollectionResultOfT(ContainerClient client, string containerId, long? limit, string order, string after, RequestOptions options)
        {
