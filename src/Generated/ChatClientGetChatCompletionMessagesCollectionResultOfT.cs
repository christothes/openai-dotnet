...
namespace OpenAI.Chat
{
    internal partial class ChatClientGetChatCompletionMessagesCollectionResultOfT : CollectionResult<ChatCompletionMessageListDatum>
    {
        ...
        public ChatClientGetChatCompletionMessagesCollectionResultOfT(ChatClient client, string completionId, string after, long? limit, string order, RequestOptions options)
        {
