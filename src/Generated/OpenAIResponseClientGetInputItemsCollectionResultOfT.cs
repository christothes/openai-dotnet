...
namespace OpenAI.Responses
{
    internal partial class OpenAIResponseClientGetInputItemsCollectionResultOfT : CollectionResult<ResponseItem>
    {
        ...
        public OpenAIResponseClientGetInputItemsCollectionResultOfT(OpenAIResponseClient client, string responseId, long? limit, string order, string after, string before, RequestOptions options)
        {
