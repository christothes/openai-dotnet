...
namespace OpenAI.VectorStores
{
    internal partial class VectorStoreClientGetVectorStoreFilesCollectionResult : CollectionResult
    {
        ...
        public VectorStoreClientGetVectorStoreFilesCollectionResult(VectorStoreClient client, string vectorStoreId, long? limit, string order, string after, string before, string filter, RequestOptions options)
        {
