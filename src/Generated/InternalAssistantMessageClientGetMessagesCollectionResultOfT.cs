...
namespace OpenAI.Assistants
{
    internal partial class InternalAssistantMessageClientGetMessagesCollectionResultOfT : CollectionResult<ThreadMessage>
    {
        ...
        internal InternalAssistantMessageClientGetMessagesCollectionResultOfT(InternalAssistantMessageClient client, string threadId, long? limit, string order, string after, string before, RequestOptions options)
        {
