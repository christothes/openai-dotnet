...
namespace OpenAI
{
    internal static partial class OpenAIModelFactory
    {
        ...
        public static CheckpointCollectionOptions CheckpointCollectionOptions(string afterId = default, int? pageSizeLimit = default, IDictionary<string, string> metadata = default, string model = default)
        {
            metadata ??= new ChangeTrackingDictionary<string, string>();

            return new CheckpointCollectionOptions(afterId, pageSizeLimit, metadata, model, additionalBinaryDataProperties: null);
        }
