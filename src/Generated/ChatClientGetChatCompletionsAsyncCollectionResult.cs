...
namespace OpenAI.Chat
{
    internal partial class ChatClientGetChatCompletionsAsyncCollectionResult : AsyncCollectionResult
    {
        ...
        public ChatClientGetChatCompletionsAsyncCollectionResult(ChatClient client, string after, long? limit, string order, IDictionary<string, string> metadata, string model, RequestOptions options)
        {
            _client = client;
            _after = after;
            _limit = limit;
