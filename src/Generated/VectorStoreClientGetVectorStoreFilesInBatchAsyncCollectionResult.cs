...
namespace OpenAI.VectorStores
{
    internal partial class VectorStoreClientGetVectorStoreFilesInBatchAsyncCollectionResult : AsyncCollectionResult
    {
        ...
        public VectorStoreClientGetVectorStoreFilesInBatchAsyncCollectionResult(VectorStoreClient client, string vectorStoreId, string batchId, long? limit, string order, string after, string before, string filter, RequestOptions options)
        {
