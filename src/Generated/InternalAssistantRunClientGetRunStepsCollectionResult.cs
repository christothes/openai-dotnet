...
namespace OpenAI.Assistants
{
    internal partial class InternalAssistantRunClientGetRunStepsCollectionResult : CollectionResult
    {
        ...
        internal InternalAssistantRunClientGetRunStepsCollectionResult(InternalAssistantRunClient client, string threadId, string runId, long? limit, string order, string after, string before, IEnumerable<InternalIncludedRunStepProperty> include, RequestOptions options)
        {
