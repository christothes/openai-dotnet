...
namespace OpenAI.VectorStores
{
    internal partial class VectorStoreClientGetVectorStoresAsyncCollectionResult : AsyncCollectionResult
    {
        ...
        public VectorStoreClientGetVectorStoresAsyncCollectionResult(VectorStoreClient client, long? limit, string order, string after, string before, RequestOptions options)
        {
            _client = client;
            _limit = limit;
            _order = order;
