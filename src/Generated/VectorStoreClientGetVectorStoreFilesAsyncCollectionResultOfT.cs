...
namespace OpenAI.VectorStores
{
    internal partial class VectorStoreClientGetVectorStoreFilesAsyncCollectionResultOfT : AsyncCollectionResult<VectorStoreFile>
    {
        ...
        public VectorStoreClientGetVectorStoreFilesAsyncCollectionResultOfT(VectorStoreClient client, string vectorStoreId, long? limit, string order, string after, string before, string filter, RequestOptions options)
        {
