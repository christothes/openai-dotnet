...
namespace OpenAI.Assistants
{
    internal partial class InternalAssistantRunClientGetRunStepsAsyncCollectionResult : AsyncCollectionResult
    {
        ...
        internal InternalAssistantRunClientGetRunStepsAsyncCollectionResult(InternalAssistantRunClient client, string threadId, string runId, long? limit, string order, string after, string before, IEnumerable<InternalIncludedRunStepProperty> include, RequestOptions options)
        {
