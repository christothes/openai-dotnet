...
namespace OpenAI.VectorStores
{
    internal partial class VectorStoreClientGetVectorStoreFilesCollectionResultOfT : CollectionResult<VectorStoreFile>
    {
        ...
        public VectorStoreClientGetVectorStoreFilesCollectionResultOfT(VectorStoreClient client, string vectorStoreId, long? limit, string order, string after, string before, string filter, RequestOptions options)
        {
