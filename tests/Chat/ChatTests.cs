...
public class ChatTests : OpenAIRecordedTestBase
{
    ...
    [Test]
    public async Task StreamingChatProtocolModelAsync()
    {
        AssertAsyncOnly();
        ...
        TimeSpan? latestTokenReceiptTime = null;
        Stopwatch stopwatch = Stopwatch.StartNew();
        AsyncCollectionResult<StreamingChatCompletionUpdate> streamingResult = client.CompleteChatStreamingAsync(
